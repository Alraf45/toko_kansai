...
<body class="bg-gray-100 text-gray-800">
  ...
  <div class="flex">
    ...
    <aside class="w-1/5 bg-sky-400 h-screen p-16">
      ...
      <ul class="space-y-2">
        <li><a href="/dashboard/users" class="block py-1 text-white hover:text-black font-mono mt-8">Users</a></li>
        <li><a href="/dashboard/products" class="block py-1 text-white hover:text-black font-mono mt-8">Products</a></li>
